...
import cn.sinobest.es.util.FullDoesInsertUtil;
...
public class TestServiceImpl implements ITestService {
    ...
    public void fulldose() {
        FullDoesInsertUtil util = new FullDoesInsertUtil();
        util.setElasticSearchService(elasticSearchService);
        util.setIncrease(PropertiesUtil.getAsBoolean("fulldose.properties","isIncrease"));
        util.setIncreaseSize(PropertiesUtil.getAsInt("fulldose.properties","increaseSize"));
        util.setOpen(PropertiesUtil.getAsBoolean("fulldose.properties","isOpen"));
        util.setSql(PropertiesUtil.getAsString("fulldose.properties","sql"));
        util.setStartTime(PropertiesUtil.getAsString("fulldose.properties","startTime"));
        util.setIndex(PropertiesUtil.getAsString("fulldose.properties","index"));
        util.setType(PropertiesUtil.getAsString("fulldose.properties","type"));
        util.execute();
    }
